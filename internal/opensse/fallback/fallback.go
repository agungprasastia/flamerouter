...
type rrConnState struct {
	...
	lastUsedSeq         int64 // monotonic; higher = more recent
	lastUsedAt          string
}
...
type Fallback struct {
	...
	rr       map[string]*rrConnState // key: connection ID
	rrMu     sync.Mutex
	rrSeq    int64
}
...
// SelectAccountWithStrategy selects next account using the given strategy.
// strategy: "fill-first" (default) or "round-robin"
