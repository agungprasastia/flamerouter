      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-white text-lg font-bold">FlameRouter</h3>
            </div>
            ...
            <div className="flex gap-4">
              <a
                ...
                href="https://github.com/agungprasastia/flamerouter"
                target="_blank"
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#f97815] text-sm transition-colors"
              href="https://github.com/agungprasastia/flamerouter#readme"
              target="_blank"
              rel="noopener noreferrer"
            >
              Documentation
            ...
            <a
              className="text-gray-400 hover:text-[#f97815] text-sm transition-colors"
              href="https://www.npmjs.com/package/flamerouter"
              target="_blank"
              rel="noopener noreferrer"
            >
              NPM
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#f97815] text-sm transition-colors"
              href="https://github.com/agungprasastia/flamerouter/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
            >
              MIT License
        ...
        <div className="border-t border-[#3a2f27] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © 2025 FlameRouter. All rights reserved.
          </p>
