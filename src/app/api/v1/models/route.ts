...
import { resolveKiroModels } from "open-sse/services/kiroModels";
import { resolveKimchiModels } from "open-sse/services/kimchiModels";
import { resolveQoderModels } from "open-sse/services/qoderModels";
import { resolveCopilotModels } from "open-sse/services/copilotModels";
import { resolveClinepassModels } from "open-sse/services/clinepassModels";
import { resolveGrokCliModels } from "open-sse/services/grokCliModels";
import { resolveCursorModels } from "open-sse/services/cursorModels";
import { resolveZedModels } from "open-sse/shared/zedAuth";
import { updateProviderCredentials } from "@/sse/services/tokenRefresh";
import { resolveConnectionProxyConfig } from "@/lib/network/connectionProxy";
import {
  capabilitiesFromServiceKind,
  getCapabilitiesForModel,
} from "open-sse/providers/capabilities";
...
// and break recursive loops between flamerouter instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // flamerouter instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another flamerouter fetching our /models)
