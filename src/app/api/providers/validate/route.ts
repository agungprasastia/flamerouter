...
import {
  ...
  PROVIDERS,
} from "open-sse/config/providers";
import { openaiToCommandCodeRequest } from "open-sse/translator/request/openai-to-commandcode";
import {
  resolveQoderCredentials,
  resolveQoderModels,
} from "open-sse/services/qoderModels";
      ...
      switch (provider) {
        ...
        case "qoder": {
          ...
          try {
            ...
            const result = await resolveQoderModels(resolved, {
              forceRefresh: true,
            });
