...
export default function CodexToolCard({
  ...
  const handleApplySettings = async () => {
    ...
    setMessage(null);
    try {
      // Use sk_flamerouter for localhost if no key, otherwise use selected key
      const keyToUse =
  ...
  const getManualConfigs = () => {
    ...
    const configContent = `# FlameRouter Configuration for Codex CLI
model = "${selectedModel}"
model_provider = "flamerouter"

[model_providers.flamerouter]
name = "FlameRouter"
