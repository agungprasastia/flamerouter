 ...
 * If flamerouter's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
 ...
 *   3. Forward to flamerouter /v1/chat/completions (OpenAI SSE)
