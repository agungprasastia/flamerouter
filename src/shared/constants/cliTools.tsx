...
export const CLI_TOOLS = {
  ...
  amp: {
    ...
    notes: [
      {
        type: "info",
        text: "Use FlameRouter model aliases to keep Amp shorthand mappings stable across provider updates.",
      },
      {
        type: "warning",
    ...
    guideSteps: [
      ...
      { step: 4, title: "Select Model", type: "modelSelector" },
      {
        ...
        desc: "Map Amp shorthand names such as g25p or cs45 to FlameRouter aliases in your local config.",
      },
    ],
    codeBlock: {
      language: "bash",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  qwen: {
    ...
    color: "#10B981",
    description:
      "Alibaba Qwen Code CLI — supports OpenAI, Anthropic & Gemini providers via FlameRouter",
    docsUrl:
    ...
    notes: [
      {
        type: "info",
        text: "Qwen Code supports multiple provider types (openai, anthropic, gemini) via modelProviders in settings.json. FlameRouter works as an OpenAI-compatible endpoint.",
      },
      {
        type: "info",
        text: "Any model available in FlameRouter can be used — not just Qwen models. Select from Qwen, Claude, Gemini, GPT, and more.",
      },
      {
        type: "warning",
      ...
      {
        type: "error",
        text: "Qwen OAuth free tier was discontinued on 2026-04-15. Use FlameRouter with alicode/openrouter/anthropic/gemini providers instead.",
      },
    ],
    modelAliases: [
      "coder-model",
  ...
  "deepseek-tui": {
    ...
    notes: [
      {
        type: "info",
        text: "DeepSeek TUI uses ~/.deepseek/config.toml for configuration. FlameRouter will update the provider to 'openai' mode with your base_url, api_key, and model.",
      },
      {
        type: "warning",
  ...
  jcode: {
    ...
    notes: [
      ...
      {
        type: "info",
        text: "Configure flamerouter as an OpenAI-compatible provider to route all jcode requests through flamerouter's optimization layer.",
      },
      {
        type: "warning",
  ...
  "grok-build": {
    ...
    notes: [
      {
        type: "info",
        text: "Grok Build uses ~/.grok/config.toml. FlameRouter writes a [model.flamerouter] custom model and sets it as the default.",
      },
      {
        type: "info",
        text: "After Apply, run grok (or /model flamerouter) to use the routed model. Switch back anytime with /model grok-build.",
      },
      {
        type: "warning",
...
devin --version`,
  ...
  opendesign: {
    ...
    notes: [
      {
        type: "info",
        text: "OpenDesign ships as a plugin/skills pack installed into Claude Code, Cursor, OpenAI Codex, Gemini CLI, or OpenCode. It inherits the host agent's model config, so once your host points at FlameRouter, /opendesign design sessions route through FlameRouter automatically — no extra env vars needed.",
      },
      {
        type: "info",
    ...
    guideSteps: [
      ...
      },
      {
        ...
        desc: "OpenDesign runs inside your host agent and uses its model config. If the host already routes through FlameRouter, /opendesign traffic does too.",
      },
      {
        step: 3,
