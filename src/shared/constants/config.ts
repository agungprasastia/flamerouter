...
export const GITHUB_CONFIG = {
  changelogUrl:
    "https://raw.githubusercontent.com/agungprasastia/flamerouter/refs/heads/master/CHANGELOG.md",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "flamerouter",
  installCmd: "npm i -g flamerouter",
  installCmdLatest: "npm i -g flamerouter@latest --prefer-online",
